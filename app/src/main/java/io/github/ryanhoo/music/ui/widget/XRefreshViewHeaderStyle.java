 ...
 * Date: 2018/11/25 下午9:51
 * ModifyTime: 下午9:51
 * Description:
 */
public class XRefreshViewHeaderStyle extends LinearLayout implements IHeaderCallBack {
    ...
    public XRefreshViewHeaderStyle(Context context) {
        super(context);
        initView(context);
    }
     ...
     * @param attrs
     */
    public XRefreshViewHeaderStyle(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context) {
        mContent = (ViewGroup) LayoutInflater.from(context).inflate(
                R.layout.xrefreshview_header_tyle, this);
