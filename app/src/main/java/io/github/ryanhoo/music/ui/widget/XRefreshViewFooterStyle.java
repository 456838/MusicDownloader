 ...
 * Date: 2018/11/25 下午9:53
 * ModifyTime: 下午9:53
 * Description:
 */
public class XRefreshViewFooterStyle extends LinearLayout implements IFooterCallBack {
    ...
    public XRefreshViewFooterStyle(Context context) {
        super(context);
        initView(context);
    }

    public XRefreshViewFooterStyle(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
...
//        setVisibility(show?VISIBLE:GONE);
    ...
    private void initView(Context context) {
        mContext = context;
        ViewGroup moreView = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.xrefreshview_footer_style, this);
